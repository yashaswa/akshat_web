...
const AboutPage = () => (
  <div className="container mx-auto px-4 py-12">
    <h1 className="text-4xl font-bold text-center mb-12">About ABC Flour</h1>
    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <section className="text-center">
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          Founded in 1995, ABC Flour has been a trusted name in the wholesale flour industry for over 25 years.
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="bg-amber-50 p-4 rounded-lg">
              <h4 className="font-semibold text-lg">25+ Years Experience</h4>
      ...
      <section className="bg-gray-100 p-8 rounded-lg">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { name: "John Smith", role: "Founder & CEO", experience: "30 years in flour industry" },
            { name: "Sarah Johnson", role: "Quality Manager", experience: "Food science expert" },
            { name: "Mike Davis", role: "Operations Director", experience: "Logistics specialist" }
          ].map((member, index) => (
